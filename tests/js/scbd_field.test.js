...
// Provide the globals expected by scbd_field-2-0-9.js when it runs in the browser.
global.jQuery = {};
global.Drupal = { behaviors: {} };

const { mountVueApp, hideTextFormat } = require('../../scbd_field-2-0-9.js');

describe('scbd_field-2-0-9.js', () => {
